...
public  class MyKeyboard {
	...
	private static  MyKeyboard keyboard =null;
	
	private MyKeyboard() throws AWTException {
		
		this.robot= new Robot();
	}
	
	public static MyKeyboard getMyKeyboard() throws AWTException {
	...
	public static  void doType(int intKeyCode) {
	
    	robot.keyPress(intKeyCode);
    	robot.keyRelease(intKeyCode);
	}
	
	  private static void doType(int keyShit,int keyCodes) {
	    	if(keyCodes==0) 
	    	{
	    		return; 
	    	}
	...
	public static  void  getResult(String str) {
		System.out.println();
		char[] indexStrings = str.toCharArray();
		for (char i : indexStrings) {
			System.out.println("===========");
			testKey(i);
	...
	public static void testKey(char i) {
	       switch (i) {
